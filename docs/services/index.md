...
- Specifications-as-Code, Documentation-**as-Code**
- Architectural design with **arc42** and **aim42** (views on systems and software)
- Working practices and structures aligned with Automotive SPICE 4.x, Medical **SPICE** (if you like)
- **Inner Source** (asynchronous, distributed, visible collaboration, written, reviewable, auditable communication)
- **Continuous** Integration / Deployment / Delivery for software as well as specifications and documentation
- Agile at team and scaling level: **SCRUM**, Essential SAFe 6.x
- **AI** in engineering workflows (agentic coding, writing) integrated into the above methods
- **Integration into IT** infrastructures in collaboration with customers' IT-Team

## Tools & Ecosystems (extract)

Depending on your environment, I can work with and integrate into tool stacks such as:
